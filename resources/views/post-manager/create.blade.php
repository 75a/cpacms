    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-3">
                <form action="/post-manager" method="post">
                    @csrf
                    @method('post')
                    <div>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text" id="metatitle" name="metatitle"/>
                        @error('metatitle')
                        <small>{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea class="border p-2 w-full" id="metadescription" name="metadescription"></textarea>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text" id="metaauthor" name="metaauthor"/>
                        @error('metaauthor')
                        <small>{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="menu_link_text" id="menu_link_text"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="menu_link_product_name" id="menu_link_product_name"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="menu_link_product_url" id="menu_link_product_url"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="featured_header" id="featured_header"/>
                    ...
                    <div>
                        ...
                        <textarea class="border p-2 w-full" id="featured_description" name="featured_description"></textarea>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="featured_image_src" id="featured_image_src"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="featured_image_alt" id="featured_image_alt"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="article_header" id="article_header"/>
                    ...
                    <div>
                        ...
                        <textarea class="border p-2 w-full" id="article_text" name="article_text"></textarea>
                        @error('article_text')
                        <small>{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="generator_header" id="generator_header"/>
                    ...
                    <div>
                        ...
                        <textarea class="border p-2 w-full" id="inputs" name="inputs"></textarea>
                        @error('inputs')
                        <small>{{$message}}</small>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="call_to_action_header" id="call_to_action_header"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="call_image1_src" id="call_image1_src"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="call_image1_alt" id="call_image1_alt"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="call_image2_src" id="call_image2_src"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="call_image2_alt" id="call_image2_alt"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="call_image3_src" id="call_image3_src"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="call_image3_alt" id="call_image3_alt"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="secondstepfinished" id="secondstepfinished"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="thirdsteperror" id="thirdsteperror"/>
                    ...
                    <div>
                        ...
                        <x-jet-input class="block mt-1 w-full" type="text"
                                     name="thirdstepwaiting" id="thirdstepwaiting"/>
